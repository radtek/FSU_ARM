...
int MsgGetFtpRtnDat::makeOutXml(bool bSuccess, string &str2SC) {
#if _SDEBUG_DETAIL_
	...
	xmlNewChild(info, NULL, BAD_CAST "UserName", BAD_CAST gDat.cfgs[GIDX_FTP_USERNAME].c_str());
	xmlNewChild(info, NULL, BAD_CAST "Password", BAD_CAST gDat.cfgs[GIDX_FTP_PASSWORD].c_str());
...
int MsgGetFtpRtnDat::parseXmlInfoPart(string &xmlStr) {
